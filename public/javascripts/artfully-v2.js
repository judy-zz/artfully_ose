...
artfully.utils = (function() {
  ...
  function show_uri(id) {
    return artfully.config.base_uri + 'shows/' + id + '.jsonp?callback=?';
  }
...
artfully.widgets = (function(){
  ...
  artfully_show = function(){
    function prep(data){
      ...
      artfully.utils.modelize(data.event, artfully.models.artfully_event);

      artfully.utils.modelize(data, artfully.models.performance);
    ...
    return widgetCache.artfully_show;
  };
    ...
    if(modelCache.performance === undefined){
      modelCache.performance = {
        render: function(target, expanded, asRoot){
          ...
          if (expanded == false && performance_link !== undefined) {            
